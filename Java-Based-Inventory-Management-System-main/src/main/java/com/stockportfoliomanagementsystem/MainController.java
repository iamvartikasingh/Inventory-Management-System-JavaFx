...
public class MainController implements Initializable {
            ...
            if (isEmailValid(username)) {
                ...
                try (PreparedStatement pstmt = conn.prepareStatement(sql)) {
                    ...
                    if ((DBPwd != null) && (DBPwd.equals(password))) {
                        ...
                        // Push current screen FXML (login screen) before navigating
                        screenHistory.push("/com/stockportfoliomanagementsystem/Main.fxml");
    ...
    public static void goBack(Stage stage) {
        if (!screenHistory.isEmpty()) {
            String fxmlPath = screenHistory.pop();
            try {
                Parent root = FXMLLoader.load(MainController.class.getResource(fxmlPath));
...
//
//public class MainController implements Initializable {
//	  public static Stack<Parent> screenHistory = new Stack<>();
//    Connection conn = MySqlCon.MysqlMethod();
//    @FXML
//    private AnchorPane aPane;
//    @FXML
